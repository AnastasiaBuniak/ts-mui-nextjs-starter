    ...
    return (
        ...
        >
            {isMobile ? (
                ...
                <>
                    <CalendarInput label={props.enterTitle as string} value={enter} onChange={(val) => setEnter(val)} />
                    <CalendarInput label={props.exitTitle as string} value={exit} onChange={(val) => setExit(val)} />
                </>
            )}
            <Button
                type="submit"
